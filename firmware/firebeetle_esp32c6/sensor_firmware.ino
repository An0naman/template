 ...
 * 
 * Hardware: ESP32-WROOM-32 / Firebeetle 2 ESP32-C6
 * Framework: Arduino
 * 
 * Supported Boards:
...
// Auto-detect board type based on chip model
...
#else
    #define BOARD_TYPE "esp32_generic"
...
const char* SENSOR_TYPE = BOARD_TYPE;  // Now dynamically set based on detected board
const char* FIRMWARE_VERSION = "2.1.0";  // Updated for multi-board support
...
// ============================================================================
...
#if CONFIG_IDF_TARGET_ESP32C6
    // Firebeetle 2 ESP32-C6 Pin Configuration
    ...
    #define RELAY_PIN 25              // GPIO25 for relay control
...
void setup() {
    ...
    WebSerial.println("========================================");
    WebSerial.println("Board: " + String(BOARD_NAME));
    WebSerial.println("Chip: " + String(CHIP_MODEL));
    WebSerial.println("Sensor ID: " + String(SENSOR_ID));
    WebSerial.println("Board Type: " + String(BOARD_TYPE));
...
bool registerWithMaster() {
    ...
    doc["board_type"] = BOARD_TYPE;  // Add explicit board type
    doc["hardware_info"] = String(BOARD_NAME) + " (" + String(CHIP_MODEL) + ")";
